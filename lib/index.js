          ...
          if (chr0 === '/' && line[1] === '/') {
            ...
            if (verbatim && chr0 === ' ') {
              ...
              hardbreakState
                ...
                : (lastLine &&= hardbreak(lastLine, '\\')) && (accum[accum.length - 1] = lastLine)
            }
          } else if (chr0 === '.') {
            subs = NORMAL_SUBS
...
function hardbreak (line, mark) {
  return line[line.length - 1] === '+' && line[line.length - 2] === ' ' ? line.slice(0, -2) + mark : undefined
}
