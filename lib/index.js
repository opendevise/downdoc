...
function downdoc (asciidoc, { attributes } = {}) {
  ...
  let blockAttrlist, blockTitle, cap, hardbreak, indent, outdent, subs, match, verbatim
  return lines
    .reduce((accum, line) => {
      while (true) {
