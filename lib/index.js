      ...
      while (true) {
        ...
        if (skipping) {
          ...
          if (chr0 === ':') {
            ...
            const [, id] = (prev && prev.charAt() === '[' && prev.match(BlockIdRx)) || [, autoId]
            refs[id] = { autoId, title }
            ...
            line = substituteAttributeReferences(line, attrs)
              ...
              .replace(InternalXrefRx, (_, _id, _text = '', id = _id, text = _text) => `[${text}](#${id})`)
