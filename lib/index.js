...
const ATTRIBUTES = ((data) => JSON.parse('{"' + data.replace(/=/g, '":"').replace(/,/g, '","') + '"}'))(
  'empty=,idprefix=_,idseparator=_,markdown-line-break=\\\\,nbsp=&#160;,quotes=<q> </q>,sp= ,vbar=|,zwsp=&#8203;'
)
...
module.exports = function downdoc (asciidoc, { attributes: initialAttrs = {} } = {}) {
  const attrs = Object.assign({}, ATTRIBUTES, initialAttrs)
