...
module.exports = function downdoc (asciidoc, { attributes } = {}) {
  const attrs = Object.assign({}, DEFAULT_ATTRS, (attributes ??= {}))
  delete attrs.doctitle
  const lines = asciidoc.split('\n')
  if (lines[lines.length - 1] === '') lines.pop()
  let inContainer = false, inHeader, inList, inPara = false, inTable // prettier-ignore
  ...
  let blockAttrs, blockTitle, grab, hardbreakAtNext, indent = '', listStack = [], match, skipping, subs, style, verbatim // prettier-ignore
