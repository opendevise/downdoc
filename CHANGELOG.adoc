...
* Support natural xrefs (xref that identifies target ref by title)
...
* End literal paragraph (and enclosing list, if relevant) at directly adjacent block attribute line
