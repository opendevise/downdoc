...
* block titles
* formatted text (bold, italic, monospace, highlight/marked, phrase with line-through role, double curly quotes, curly apostrophe)
...
* list continuation (no support for ancestor attachment)
* link and URL macros
* escaped bare URLs
...
Additional syntax may be supported in the future.
...
[,console]
----
$ npx downdoc -a markdown-list-indent=4 -a product-name="ACME Enterprise" README.adoc
----
